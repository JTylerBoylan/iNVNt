...
int main(int argc, char **argv)
{
    ...
    auto leg_control_fl = Chain(std::move(stance_cond_fl), set_force_fl);
    auto leg_control_rr = Chain(std::move(stance_cond_rr), set_force_rr);
    auto leg_control_rl = Chain(std::move(stance_cond_rl), set_force_rl);
